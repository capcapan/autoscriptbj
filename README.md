...
```
apt install -y && apt update -y && apt upgrade -y && wget -q https://raw.githubusercontent.com/capcapan/autoscript/main/setup.sh && chmod +x setup.sh && ./setup.sh
```
...
```
## sewa autoscript bisa ke t.me/capcapan cuman 10k 2bulan 1ip vps
